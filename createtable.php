...
$pwd = "password";
$db = "efremovAu91BFbnU";
В данном фрагменте указываем значения подключения к базе данных.
В следующем фрагменте кода будет идет подключение к базе данных и создание в ней таблицы, которая будет содержать три поля (Name, email, data)
